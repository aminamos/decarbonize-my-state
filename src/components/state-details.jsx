...
import ScrollspyModule from "react-scrollspy"

// react-scrollspy is CJS-with-`__esModule`; under Node's ESM loader the default
// import is the namespace object, so unwrap it.
const Scrollspy = ScrollspyModule.default || ScrollspyModule
...
import CoalTransitionImg from "../images/coal-plant-transition.png?url"
...
import PowerPlantMap from "../images/dirty-power-plants.jpg?url"

// New images
import DirtyPowerPlantImg from "../images/dirty-power-plant.png?url"
...
export default function StateDetailsPage({ stateSlug, data }) {
  /**
  ...
  const currentStateSlug = stateSlug
